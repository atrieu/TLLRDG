...
heroes =
  ...
  "Ancient Apparition" => "[url=http://wiki.teamliquid.net/dota2/Ancient_Apparition][h]ancient[/h][/url]"
  ...
  , "Bounty Hunter" => "[url=http://wiki.teamliquid.net/dota2/Bounty_Hunter][h]bounty[/h][/url]"
  ...
  , "Chaos Knight" => "[url=http://wiki.teamliquid.net/dota2/Chaos_Knight][h]chaos[/h][/url]"
  ...
  , "Dragon Knight" => "[url=http://wiki.teamliquid.net/dota2/Dragon_Knight][h]dragon[/h][/url]"
  , "Drow Ranger" => "[url=http://wiki.teamliquid.net/dota2/Drow_Ranger][h]drow[/h][/url]"
  , "Earth Spirit" => "[url=http://wiki.teamliquid.net/dota2/Earth_Spirit][h]earth[/h][/url]"
  , "Earthshaker" => "[url=http://wiki.teamliquid.net/dota2/Earthshaker][h]earthshaker[/h][/url]"
  , "Elder Titan" => "[url=http://wiki.teamliquid.net/dota2/Elder_Titan][h]elder[/h][/url]"
  , "Ember Spirit" => "[url=http://wiki.teamliquid.net/dota2/Ember_Spirit][h]ember[/h][/url]"
  ...
  , "Faceless Void" => "[url=http://wiki.teamliquid.net/dota2/Faceless_Void][h]faceless[/h][/url]"
  ...
  , "Keeper of the Light" => "[url=http://wiki.teamliquid.net/dota2/Keeper_of_the_Light][h]keeper[/h][/url]"
  , "Kunkka" => "[url=http://wiki.teamliquid.net/dota2/Kunkka][h]kunkka[/h][/url]"
  , "Legion Commander" => "[url=http://wiki.teamliquid.net/dota2/Legion_Commander][h]legion[/h][/url]"
  ...
  , "Naga Siren" => "[url=http://wiki.teamliquid.net/dota2/Naga_Siren][h]naga[/h][/url]"
  , "Nature's Prophet" => "[url=http://wiki.teamliquid.net/dota2/Natures_Prophet][h]natures[/h][/url]"
  , "Necrolyte" => "[url=http://wiki.teamliquid.net/dota2/Necrolyte][h]necrolyte[/h][/url]"
  , "Night Stalker" => "[url=http://wiki.teamliquid.net/dota2/Night_Stalker][h]night[/h][/url]"
  , "Nyx" => "[url=http://wiki.teamliquid.net/dota2/Nyx_Assassin][h]nyx[/h][/url]"
  , "Ogre Magi" => "[url=http://wiki.teamliquid.net/dota2/Ogre_Magi][h]ogre[/h][/url]"
  , "Omniknight" => "[url=http://wiki.teamliquid.net/dota2/Omniknight][h]omniknight[/h][/url]"
  , "Outworld Devourer" => "[url=http://wiki.teamliquid.net/dota2/Outworld_Devourer][h]outworld[/h][/url]"
  ...
  , "Queen of Pain" => "[url=http://wiki.teamliquid.net/dota2/Queen_of_Pain][h]queen[/h][/url]"
  ...
  , "Sand King" => "[url=http://wiki.teamliquid.net/dota2/Sand_King][h]sand[/h][/url]"
  ...
  , "Skywrath Mage" => "[url=http://wiki.teamliquid.net/dota2/Skywrath_Mage][h]skywrath[/h][/url]"
  ...
  , "Spirit Breaker" => "[url=http://wiki.teamliquid.net/dota2/Spirit_Breaker][h]spirit[/h][/url]"
  , "Storm Spirit" => "[url=http://wiki.teamliquid.net/dota2/Storm_Spirit][h]storm[/h][/url]"
  ...
  , "Templar Assassin" => "[url=http://wiki.teamliquid.net/dota2/Templar_Assassin][h]templar[/h][/url]"
  ...
  , "Treant Protector" => "[url=http://wiki.teamliquid.net/dota2/Treant_Protector][h]treant[/h][/url]"
  , "Troll Warlord" => "[url=http://wiki.teamliquid.net/dota2/Troll_Warlord][h]troll[/h][/url]"
  ...
  , "Vengeful Spirit" => "[url=http://wiki.teamliquid.net/dota2/Vengeful_Spirit][h]vengeful[/h][/url]"
